...
module Filter_Add_11Ux9U_11U_1(in2, in1, out1);
  input [10:0] in2;
  input [8:0] in1;
  output [10:0] out1;
  wire [10:0] in2;
  ...
  wire add_23_2_n_59, add_23_2_n_60, add_23_2_n_61, add_23_2_n_63,
       add_23_2_n_64, n_86, n_88, n_89;
  wire n_90, n_91, n_92, n_93, n_95, n_97;
  ...
  NOR2X2 add_23_2_g233(.A (add_23_2_n_50), .B (add_23_2_n_57), .Y
       (add_23_2_n_61));
  AOI21X1 add_23_2_g234(.A0 (add_23_2_n_37), .A1 (n_93), .B0
       (add_23_2_n_45), .Y (add_23_2_n_60));
  OAI21X1 add_23_2_g235(.A0 (add_23_2_n_24), .A1 (n_92), .B0
       (add_23_2_n_18), .Y (add_23_2_n_59));
  OAI21X1 add_23_2_g238(.A0 (add_23_2_n_47), .A1 (n_92), .B0
       (add_23_2_n_51), .Y (add_23_2_n_58));
  NOR2X2 add_23_2_g239(.A (add_23_2_n_48), .B (add_23_2_n_55), .Y
       (add_23_2_n_57));
  OAI21X1 add_23_2_g240(.A0 (add_23_2_n_15), .A1 (n_89), .B0
       (add_23_2_n_14), .Y (add_23_2_n_56));
  NOR2X2 add_23_2_g243(.A (add_23_2_n_46), .B (add_23_2_n_53), .Y
       (add_23_2_n_55));
  NOR2X2 add_23_2_g244(.A (add_23_2_n_3), .B (n_90), .Y
       (add_23_2_n_53));
  ...
  NAND2X1 add_23_2_g263(.A (add_23_2_n_25), .B (add_23_2_n_13), .Y
       (add_23_2_n_41));
  NOR2BX1 add_23_2_g264(.AN (add_23_2_n_30), .B (n_97), .Y
       (add_23_2_n_40));
  ...
  NAND2BX1 add_23_2_g273(.AN (add_23_2_n_24), .B (add_23_2_n_18), .Y
       (add_23_2_n_35));
  NOR2BX1 add_23_2_g274(.AN (add_23_2_n_21), .B (n_95), .Y
       (add_23_2_n_34));
  ...
  CLKXOR2X1 add_23_2_g304(.A (add_23_2_n_40), .B (add_23_2_n_56), .Y
       (out1[3]));
  XNOR2XL add_23_2_g305(.A (add_23_2_n_35), .B (n_91), .Y (out1[4]));
  XOR2XL add_23_2_g306(.A (add_23_2_n_34), .B (add_23_2_n_59), .Y
       (out1[5]));
  XNOR2X1 add_23_2_g307(.A (add_23_2_n_33), .B (n_88), .Y (out1[2]));
  ...
  BUFX2 fopt(.A (add_23_2_n_61), .Y (n_86));
  INVXL fopt312(.A (n_89), .Y (n_88));
  BUFX3 fopt313(.A (n_90), .Y (n_89));
  CLKINVX2 fopt314(.A (add_23_2_n_49), .Y (n_90));
  INVXL fopt315(.A (n_92), .Y (n_91));
  CLKINVX2 fopt316(.A (n_93), .Y (n_92));
  CLKINVX1 fopt317(.A (add_23_2_n_55), .Y (n_93));
  BUFX2 fopt318(.A (add_23_2_n_28), .Y (n_95));
  BUFX2 fopt319(.A (add_23_2_n_29), .Y (n_97));
endmodule
