...
module Filter_Add_11Ux9U_12U_1(in2, in1, out1);
  input [10:0] in2;
  input [8:0] in1;
  output [11:0] out1;
  wire [10:0] in2;
  ...
  wire n_91, n_92, n_94, n_95, n_97, n_98, n_99, n_100;
  wire n_102, n_103, n_105, n_106, n_107, n_109, n_111;
  ...
  AOI21X1 add_23_2_g241(.A0 (add_23_2_n_38), .A1 (add_23_2_n_58), .B0
       (n_105), .Y (add_23_2_n_63));
  OAI21X1 add_23_2_g242(.A0 (add_23_2_n_16), .A1 (n_95), .B0 (n_98), .Y
       (add_23_2_n_62));
  OAI21X1 add_23_2_g245(.A0 (add_23_2_n_48), .A1 (n_95), .B0
       (add_23_2_n_54), .Y (add_23_2_n_61));
  NOR2X2 add_23_2_g246(.A (add_23_2_n_50), .B (n_97), .Y
       (add_23_2_n_60));
  OAI21X1 add_23_2_g247(.A0 (add_23_2_n_25), .A1 (n_92), .B0
  ...
  NAND2X2 add_23_2_g251(.A (add_23_2_n_37), .B (add_23_2_n_52), .Y
       (add_23_2_n_56));
  AOI21X1 add_23_2_g253(.A0 (add_23_2_n_24), .A1 (n_106), .B0
  ...
  NOR2X2 add_23_2_g263(.A (add_23_2_n_1), .B (add_23_2_n_32), .Y
       (add_23_2_n_46));
  AOI21X1 add_23_2_g264(.A0 (add_23_2_n_19), .A1 (n_102), .B0
  ...
  NAND2BX1 add_23_2_g270(.AN (add_23_2_n_17), .B (add_23_2_n_13), .Y
       (add_23_2_n_44));
  NOR2X1 add_23_2_g271(.A (n_109), .B (n_111), .Y (add_23_2_n_43));
  NOR2X1 add_23_2_g272(.A (add_23_2_n_30), .B (n_103), .Y
       (add_23_2_n_41));
  ...
  NOR2X2 add_23_2_g279(.A (add_23_2_n_20), .B (add_23_2_n_14), .Y
       (add_23_2_n_32));
  NAND2BX1 add_23_2_g281(.AN (add_23_2_n_16), .B (n_99), .Y
       (add_23_2_n_36));
  ...
  CLKXOR2X1 add_23_2_g316(.A (add_23_2_n_39), .B (add_23_2_n_63), .Y
       (out1[6]));
  XNOR2X1 add_23_2_g317(.A (add_23_2_n_36), .B (n_94), .Y (out1[4]));
  XNOR2X1 add_23_2_g318(.A (add_23_2_n_2), .B (n_91), .Y (out1[2]));
  ...
  INVXL fopt(.A (n_92), .Y (n_91));
  CLKINVX1 fopt324(.A (add_23_2_n_52), .Y (n_92));
  INVXL fopt325(.A (n_95), .Y (n_94));
  CLKINVX1 fopt326(.A (add_23_2_n_58), .Y (n_95));
  CLKINVX3 fopt327(.A (add_23_2_n_58), .Y (n_97));
  INVXL fopt328(.A (n_100), .Y (n_98));
  INVXL fopt329(.A (n_100), .Y (n_99));
  INVXL fopt330(.A (add_23_2_n_28), .Y (n_100));
  CLKINVX1 fopt331(.A (add_23_2_n_26), .Y (n_102));
  BUFX2 fopt332(.A (add_23_2_n_26), .Y (n_103));
  INVXL fopt333(.A (n_107), .Y (n_105));
  INVXL fopt334(.A (n_107), .Y (n_106));
  INVXL fopt335(.A (add_23_2_n_47), .Y (n_107));
  BUFX2 fopt336(.A (add_23_2_n_1), .Y (n_109));
  BUFX2 fopt337(.A (add_23_2_n_14), .Y (n_111));
endmodule
