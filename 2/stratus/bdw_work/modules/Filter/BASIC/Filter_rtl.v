...
module Filter( i_clk, i_rst, i_rgb_busy, i_rgb_vld, i_rgb_data, o_result_busy, o_result_vld, o_result_data );
    ...
    wire[10:0] Filter_Div_11Ux3U_11U_4_191_in2;
    wire[11:0] Filter_Sub_12Ux8U_12U_4_190_out1;
    ...
    reg[1:0] gs_ctrl_do_filter_h420001000000;
    ...
    reg[3:0] gs_ctrl_do_filter_h47febffdfb00;
    ...
    reg[2:0] gs_ctrl_do_filter_h67fffffffb80;
    ...
    reg[2:0] gs_ctrl_do_filter_h8100000000a01;
    reg[2:0] gs_ctrl_do_filter_h9d20000000a01;
    wire[10:0] Filter_Div_11Ux3U_11U_4_191_out1;
    reg gs_ctrl_do_filter_h100000000000;
    wire Filter_LessThan_2Ux2U_1U_4_193_out1;
    reg[2:0] gs_ctrl_do_filter_h1d00000000a00;
    ...
    reg[4:0] s_reg_9;
    wire[1:0] Filter_Add_2Ux1U_2U_4_192_out1;
    ...
    reg[7:0] s_reg_41;
    wire[11:0] Filter_Add_12Ux9U_12U_4_189_out1;
    ...
    always @(posedge i_clk)
      begin : drive_o_result_data
        case (stall0) 
          ...
          default: 
            begin
              o_result_data <= {result_out1[7:0], {s_reg_35[7:0], s_reg_32}};
            end
        endcase
      end
          ...
          default: 
            begin
              case (global_state) 
                6'd02: 
                  begin
                    s_reg_11_slice <= i_rgb_data[23:0];
                  end
              endcase
            end
        endcase
          ...
          default: 
            begin
              case (global_state) 
                6'd15: 
                  begin
                    s_reg_32 <= {3'b000, Filter_Add_5Ux5U_5U_4_25_out1};
                  end
                6'd25: 
                  begin
                    s_reg_32 <= box_out1;
          ...
          default: 
            begin
              case (global_state) 
                6'd27: 
                  begin
                    s_reg_35 <= {4'b0000, Filter_N_Mux_8_2_0_4_71_out1};
                  end
                6'd31: 
                  begin
                    s_reg_35 <= {4'b0000, Filter_N_Mux_8_2_0_4_122_out1};
                  end
                6'd32: 
                  begin
                    s_reg_35 <= {4'b0000, Filter_N_Mux_8_2_0_4_147_out1};
                  end
                6'd42: 
                  begin
                    s_reg_35 <= result_out1;
                  end
                6'd44: 
                  begin
                    /* state64 */
                    s_reg_35 <= Filter_Add_12Ux9U_12U_4_189_out1;
                  end
                6'd48: 
                  begin
                    s_reg_35 <= {4'b0000, result_out1[7:0]};
                  end
              endcase
            end
        endcase
                ...
                6'd44: 
                  begin
                    if (Filter_LessThan_4Ux4U_1U_4_188_out1) 
                      ...
                      begin
                        s_reg_8 <= Filter_Add_2Ux1U_2U_4_192_out1;
                      end
                  end
              endcase
            end
    ...
    assign Filter_Mul_2Ux2U_4U_4_6_out1 = {2'b00, Filter_Mul_2Ux2U_4U_4_6_in2} * 4'd03;
    ...
    always @(s_reg_18 or s_reg_8 or Filter_LessThan_2Ux2U_1U_4_193_out1 or gs_ctrl_do_filter_h1d00000000a00)
      begin : drive_result_in1
        case (gs_ctrl_do_filter_h1d00000000a00) 
          3'd1: 
            begin
              result_in1 = s_reg_18;
            end
    ...
    always @(Filter_Div_11Ux3U_11U_4_191_out1 or gs_ctrl_do_filter_h100000000000)
      begin : drive_result_DIN
        if (gs_ctrl_do_filter_h100000000000) 
          begin
            result_DIN = {1'b0, Filter_Div_11Ux3U_11U_4_191_out1};
          end 
        else 
          begin
            result_DIN = 12'd0000;
    ...
    // resource: mux_1bx2i2c
    always @(stall0 or Filter_Add_2Ux1U_2U_4_22_out1 or Filter_LessThan_2Ux2U_1U_4_26_out1 or Filter_Add_2Ux1U_2U_4_32_out1 or Filter_LessThan_2Ux2U_1U_4_33_out1 or Filter_LessThan_2Ux2U_1U_4_34_out1 or Filter_LessThan_2Ux2U_1U_4_178_out1 or Filter_LessThan_4Ux4U_1U_4_188_out1 or gs_ctrl_do_filter_h9d20000000a01)
      begin : drive_result_CE
        if (stall0) 
          ...
          begin
            case (gs_ctrl_do_filter_h9d20000000a01) 
              3'd1: 
                begin
                  result_CE = 1'b1;
                end
    ...
    // resource: mux_1bx2i2c
    always @(stall0 or Filter_Add_2Ux1U_2U_4_22_out1 or Filter_LessThan_2Ux2U_1U_4_26_out1 or Filter_Add_2Ux1U_2U_4_32_out1 or Filter_LessThan_2Ux2U_1U_4_33_out1 or Filter_LessThan_2Ux2U_1U_4_34_out1 or Filter_LessThan_4Ux4U_1U_4_188_out1 or gs_ctrl_do_filter_h8100000000a01)
      begin : drive_result_RW
        if (stall0) 
          ...
          begin
            case (gs_ctrl_do_filter_h8100000000a01) 
              3'd1: 
                begin
                  result_RW = 1'b1;
                end
    ...
    // resource: mux_8bx3i0c
    always @(i_rgb_data[7:0] or gs_ctrl_do_filter_h18 or s_reg_11_slice[23:8])
      begin : drive_color_DIN
        case (gs_ctrl_do_filter_h18) 
          2'd1: 
            begin
              color_DIN = s_reg_11_slice[15:8];
            end
          2'd2: 
            begin
              color_DIN = s_reg_11_slice[23:16];
            end
          default: 
            begin
    ...
    always @(s_reg_8 or Filter_Add_2Ux1U_2U_4_22_out1 or Filter_Add_2Ux1U_2U_4_32_out1 or Filter_Add_2Ux1U_2U_4_58_out1 or Filter_LessThan_2Ux2U_1U_4_178_out1 or gs_ctrl_do_filter_h67fffffffb80)
      begin : drive_Filter_Mul_4Ux2U_5U_4_24_in1
        case (gs_ctrl_do_filter_h67fffffffb80) 
          3'd1: 
            begin
    ...
    always @(s_reg_17 or s_reg_24[4:0] or s_reg_31[4:0] or s_reg_32[4:0] or s_reg_9 or Filter_Mul_4Ux2U_5U_4_24_out1 or Filter_Add_5Ux5U_5U_4_16_out1 or Filter_Add_5Ux5U_5U_4_20_out1 or Filter_Add_5Ux5U_5U_4_25_out1 or Filter_NotEQ_4Ux3U_1U_4_183_out1 or gs_ctrl_do_filter_h27ffffbf0500)
      begin : drive_box_in1
    ...
    always @(s_reg_24 or s_reg_31 or s_reg_32 or s_reg_35[7:0] or s_reg_41 or s_reg_42 or s_reg_49 or s_reg_50 or color_out1 or data_buffer_out1 or Filter_N_Mux_8_2_0_4_143_out1 or gs_ctrl_do_filter_h1ff00000100)
      begin : drive_box_DIN
    ...
    always @(s_reg_17[3:0] or s_reg_9 or Filter_Add_2Ux1U_2U_4_58_out1 or gs_ctrl_do_filter_h47febffdfb00)
      begin : drive_Filter_Add_5Ux5U_5U_4_25_in1
        case (gs_ctrl_do_filter_h47febffdfb00) 
          4'd01: 
            begin
    ...
    // resource: mux_1bx2i2c
    always @(stall0 or Filter_LessThan_2Ux2U_1U_4_178_out1 or Filter_LessThan_2Ux2U_1U_4_193_out1 or gs_ctrl_do_filter_h420001000000)
      begin : drive_center_CE
        if (stall0) 
          ...
          begin
            case (gs_ctrl_do_filter_h420001000000) 
              2'd1: 
                begin
                  center_CE = 1'b1;
                end
    ...
    assign Filter_LessThan_8Ux8U_1U_4_96_out1 = Filter_N_Mux_8_2_0_4_94_out1 < s_reg_35[7:0];
    ...
    always @(s_reg_35[7:0] or Filter_N_Mux_8_2_0_4_94_out1 or Filter_LessThan_8Ux8U_1U_4_96_out1)
      begin : Filter_N_Mux_8_2_0_4_98
        if (Filter_LessThan_8Ux8U_1U_4_96_out1) 
          ...
          begin
            Filter_N_Mux_8_2_0_4_98_out1 = s_reg_35[7:0];
          end
      end
    ...
    always @(s_reg_35[7:0] or Filter_N_Mux_8_2_0_4_94_out1 or Filter_LessThan_8Ux8U_1U_4_96_out1)
      begin : Filter_N_Mux_8_2_0_4_101
        if (Filter_LessThan_8Ux8U_1U_4_96_out1) 
          begin
            Filter_N_Mux_8_2_0_4_101_out1 = s_reg_35[7:0];
          end 
        else 
          begin
    ...
    assign Filter_LessThan_8Ux8U_1U_4_138_out1 = s_reg_35[7:0] < Filter_N_Mux_8_2_0_4_137_out1;
    
    // resource: Filter_N_Mux_8_2_0_4
    always @(s_reg_35[7:0] or Filter_N_Mux_8_2_0_4_137_out1 or Filter_LessThan_8Ux8U_1U_4_138_out1)
      begin : Filter_N_Mux_8_2_0_4_139
        if (Filter_LessThan_8Ux8U_1U_4_138_out1) 
          begin
            Filter_N_Mux_8_2_0_4_139_out1 = s_reg_35[7:0];
          end 
        else 
          begin
    ...
    always @(s_reg_35[7:0] or Filter_N_Mux_8_2_0_4_137_out1 or Filter_LessThan_8Ux8U_1U_4_138_out1)
      begin : Filter_N_Mux_8_2_0_4_149
        if (Filter_LessThan_8Ux8U_1U_4_138_out1) 
          ...
          begin
            Filter_N_Mux_8_2_0_4_149_out1 = s_reg_35[7:0];
          end
      end
    ...
    assign Filter_Add_12Ux9U_12U_4_189_out1 = s_reg_35 + {3'b000, s_reg_33};
    
    // resource: Filter_Sub_12Ux8U_12U_4  instance: Filter_Sub_12Ux8U_12U_4_190
    assign Filter_Sub_12Ux8U_12U_4_190_out1 = Filter_Add_12Ux9U_12U_4_189_out1 - {4'b0000, s_reg_32};
    
    // instance: drive_Filter_Div_11Ux3U_11U_4_191_in2
    assign Filter_Div_11Ux3U_11U_4_191_in2 = Filter_Sub_12Ux8U_12U_4_190_out1[11:1];
    
    // resource: Filter_Div_11Ux3U_11U_4  instance: Filter_Div_11Ux3U_11U_4_191
    assign Filter_Div_11Ux3U_11U_4_191_out1 = Filter_Div_11Ux3U_11U_4_191_in2 / 3'd5;
    
    // resource: Filter_Add_2Ux1U_2U_4  instance: Filter_Add_2Ux1U_2U_4_192
    assign Filter_Add_2Ux1U_2U_4_192_out1 = s_reg_8 + 2'd1;
    ...
    always @(posedge i_clk)
      begin : drive_gs_ctrl_do_filter_h1d00000000a00
        if (i_rst == 1'b0) 
          begin
            gs_ctrl_do_filter_h1d00000000a00 <= 3'd0;
          end 
        else 
          begin
            case (stall0) 
              ...
              default: 
                begin
                  case (global_state_next) 
                    6'd09, 6'd11: 
                      begin
                        gs_ctrl_do_filter_h1d00000000a00 <= 3'd1;
                      end
                    6'd44: 
                      begin
                        gs_ctrl_do_filter_h1d00000000a00 <= 3'd2;
                      end
                    6'd46: 
                      begin
                        gs_ctrl_do_filter_h1d00000000a00 <= 3'd3;
                      end
                    6'd47: 
                      begin
                        gs_ctrl_do_filter_h1d00000000a00 <= 3'd4;
                      end
                    6'd48: 
                      begin
                        gs_ctrl_do_filter_h1d00000000a00 <= 3'd5;
                      end
                    default: 
                      begin
                        gs_ctrl_do_filter_h1d00000000a00 <= 3'd0;
    ...
    // resource: regr_en_sc_1
    always @(posedge i_clk)
      begin : drive_gs_ctrl_do_filter_h100000000000
        if (i_rst == 1'b0) 
          begin
            gs_ctrl_do_filter_h100000000000 <= 1'b0;
          end 
        else 
          begin
            case (stall0) 
              ...
              default: 
                begin
                  case (global_state_next) 
                    6'd44: 
                      begin
                        gs_ctrl_do_filter_h100000000000 <= 1'b1;
                      end
                    default: 
                      begin
                        gs_ctrl_do_filter_h100000000000 <= 1'b0;
    ...
    always @(posedge i_clk)
      begin : drive_gs_ctrl_do_filter_h9d20000000a01
        if (i_rst == 1'b0) 
          begin
            gs_ctrl_do_filter_h9d20000000a01 <= 3'd1;
          end 
        else 
          begin
            case (stall0) 
              ...
              default: 
                begin
                  case (global_state_next) 
                    6'd00, 6'd46, 6'd47, 6'd48, 6'd51: 
                      begin
                        gs_ctrl_do_filter_h9d20000000a01 <= 3'd1;
                      end
                    6'd09: 
                      begin
                        gs_ctrl_do_filter_h9d20000000a01 <= 3'd2;
                      end
                    6'd11: 
                      begin
                        gs_ctrl_do_filter_h9d20000000a01 <= 3'd3;
                      end
                    6'd41: 
                      begin
                        gs_ctrl_do_filter_h9d20000000a01 <= 3'd4;
                      end
                    6'd44: 
                      begin
                        gs_ctrl_do_filter_h9d20000000a01 <= 3'd5;
                      end
                    default: 
                      begin
                        gs_ctrl_do_filter_h9d20000000a01 <= 3'd0;
                      end
                  endcase
                end
            endcase
    ...
    // resource: regr_en_ss_sc_3
    always @(posedge i_clk)
      begin : drive_gs_ctrl_do_filter_h8100000000a01
        if (i_rst == 1'b0) 
          begin
            gs_ctrl_do_filter_h8100000000a01 <= 3'd1;
          end 
        else 
          begin
            case (stall0) 
              ...
              default: 
                begin
                  case (global_state_next) 
                    ...
                    6'd09: 
                      begin
                        gs_ctrl_do_filter_h8100000000a01 <= 3'd2;
                      end
                    6'd11: 
                      begin
                        gs_ctrl_do_filter_h8100000000a01 <= 3'd3;
                      end
                    6'd44: 
                      begin
                        gs_ctrl_do_filter_h8100000000a01 <= 3'd4;
                      end
                    default: 
                      begin
                        gs_ctrl_do_filter_h8100000000a01 <= 3'd0;
                      end
                  endcase
                end
            endcase
    ...
    // resource: regr_en_sc_3
    always @(posedge i_clk)
      begin : drive_gs_ctrl_do_filter_h67fffffffb80
        if (i_rst == 1'b0) 
          begin
            gs_ctrl_do_filter_h67fffffffb80 <= 3'd0;
          end 
        else 
          begin
            case (stall0) 
              ...
              default: 
                begin
                  case (global_state_next) 
                    6'd07, 6'd08, 6'd12, 6'd13, 6'd14, 6'd15, 6'd16, 6'd17, 6'd18, 6'd19, 6'd20, 6'd21, 6'd22, 6'd24, 6'd25, 6'd26, 6'd27, 6'd28, 6'd29, 6'd30, 6'd31, 6'd32, 6'd33, 6'd34, 6'd35, 6'd36, 6'd37, 6'd38, 6'd39, 6'd40, 6'd42, 6'd45, 6'd46: 
                      begin
                        gs_ctrl_do_filter_h67fffffffb80 <= 3'd1;
                      end
                    6'd09: 
                      begin
                        gs_ctrl_do_filter_h67fffffffb80 <= 3'd2;
                      end
                    6'd11: 
                      begin
                        gs_ctrl_do_filter_h67fffffffb80 <= 3'd3;
                      end
                    6'd23: 
                      begin
                        gs_ctrl_do_filter_h67fffffffb80 <= 3'd4;
                      end
                    6'd41: 
                      begin
                        gs_ctrl_do_filter_h67fffffffb80 <= 3'd5;
                      end
                    default: 
                      begin
                        gs_ctrl_do_filter_h67fffffffb80 <= 3'd0;
    ...
    // resource: regr_en_sc_4
    always @(posedge i_clk)
      begin : drive_gs_ctrl_do_filter_h47febffdfb00
        if (i_rst == 1'b0) 
          begin
            gs_ctrl_do_filter_h47febffdfb00 <= 4'd00;
          end 
        else 
          begin
            case (stall0) 
              ...
              default: 
                begin
                  case (global_state_next) 
                    6'd08: 
                      begin
                        gs_ctrl_do_filter_h47febffdfb00 <= 4'd01;
                      end
                    6'd09, 6'd11, 6'd18, 6'd24, 6'd33: 
                      begin
                        gs_ctrl_do_filter_h47febffdfb00 <= 4'd02;
                      end
                    6'd12, 6'd19, 6'd25, 6'd34: 
                      begin
                        gs_ctrl_do_filter_h47febffdfb00 <= 4'd03;
                      end
                    6'd13, 6'd21, 6'd36, 6'd41, 6'd46: 
                      begin
                        gs_ctrl_do_filter_h47febffdfb00 <= 4'd04;
                      end
                    6'd14, 6'd22, 6'd27, 6'd37: 
                      begin
                        gs_ctrl_do_filter_h47febffdfb00 <= 4'd05;
                      end
                    6'd15, 6'd29, 6'd39: 
                      begin
                        gs_ctrl_do_filter_h47febffdfb00 <= 4'd06;
                      end
                    6'd16, 6'd31, 6'd40: 
                      begin
                        gs_ctrl_do_filter_h47febffdfb00 <= 4'd07;
                      end
                    6'd20, 6'd26, 6'd35: 
                      begin
                        gs_ctrl_do_filter_h47febffdfb00 <= 4'd08;
                      end
                    6'd23: 
                      begin
                        gs_ctrl_do_filter_h47febffdfb00 <= 4'd09;
                      end
                    6'd28, 6'd38: 
                      begin
                        gs_ctrl_do_filter_h47febffdfb00 <= 4'd10;
                      end
                    6'd42: 
                      begin
                        gs_ctrl_do_filter_h47febffdfb00 <= 4'd11;
                      end
                    default: 
                      begin
                        gs_ctrl_do_filter_h47febffdfb00 <= 4'd00;
    ...
    // resource: regr_en_sc_2
    always @(posedge i_clk)
      begin : drive_gs_ctrl_do_filter_h420001000000
        if (i_rst == 1'b0) 
          begin
            gs_ctrl_do_filter_h420001000000 <= 2'd0;
          end 
        else 
          begin
            case (stall0) 
              ...
              default: 
                begin
                  case (global_state_next) 
                    6'd24: 
                      begin
                        gs_ctrl_do_filter_h420001000000 <= 2'd1;
                      end
                    6'd41: 
                      begin
                        gs_ctrl_do_filter_h420001000000 <= 2'd2;
                      end
                    6'd46: 
                      begin
                        gs_ctrl_do_filter_h420001000000 <= 2'd3;
                      end
                    default: 
                      begin
                        gs_ctrl_do_filter_h420001000000 <= 2'd0;
